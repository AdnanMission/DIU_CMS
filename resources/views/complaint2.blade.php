                    ...
                    <form method="POST" action="{{ route('insert') }}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description_of_complaint" type="text" class="form-control @error('description_of_complaint') is-invalid @enderror" name="description_of_complaint" required autocomplete="description_of_complaint" rows="5" placeholder="">
                               </textarea> 
