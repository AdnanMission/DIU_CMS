...
<div class="container">
    <table class="table table-responsive table-hover">
      ...
      <<tr>
            <form method="POST" action="{{route('complaintdetails',$complaint_tbl->id)}}">

               <td> 
                <label>Action</label>

                   <select id="action" type="text" name="action" value="{{ $complaint_tbl->action }}" required autocomplete="action" autofocus>
                    <option>In-processing</option>
                    <option>Not valuable</option>
                    <option>Closed</option>
                    </select>    
