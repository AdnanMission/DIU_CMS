...
if (isset($messageCache)) { $message = $messageCache; }
                       ...
                       <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="types" type="text" class="form-control <?php if ($errors->has('types')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('types'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="types" value="<?php echo e($complaint_tbl->types); ?>" required autocomplete="types" autofocus readonly>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DIU_CMS\resources\views/takingaction.blade.php ENDPATH**/ ?>