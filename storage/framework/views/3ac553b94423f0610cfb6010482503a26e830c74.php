...
<div class="container" >
    <div class="row " >
        <div class="col-md-2" >
            ...
            <div class="card-header"><a href="<?php echo e(route('pnewcomplaint')); ?>">Pending Complaints</a></div>
            <div class="card-header"><a href="<?php echo e(route('cnewcomplaint')); ?>">Closed Complaints</a></div>
            <div class="card-header"><a href="<?php echo e(route('dnewcomplaint')); ?>">Complaints Details</a></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DIU_CMS\resources\views/admin.blade.php ENDPATH**/ ?>