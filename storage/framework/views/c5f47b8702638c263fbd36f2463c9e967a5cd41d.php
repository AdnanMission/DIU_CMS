...
<body style="background: linear-gradient(to right, #ada996, #c8dad9, #b4d2f2, #B2DFDB">
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo e(route('complaint')); ?>">Make Complain</a>
          <a class="dropdown-item" href="<?php echo e(route('newcomplaint1')); ?>">Status of complaint</a>
  ...
  <div class="card card-body">
                  ...
                  <strong>
                    ...
                    Id :<?php echo e(Auth::user()->student_id); ?></p>
                   </div>
                  </strong>
                  </div>
  </div>
    ...
    <div class="container">
      <div class="row">
         ...
         <a href="<?php echo e(route('complaint')); ?>"class="btn btn-primary">Make Complaint</a>
        </div>
        </div>
        </div>
        <div class="col-md-4">
         ...
         <a href="<?php echo e(route('complaint2')); ?>" class="btn btn-primary">Make Complaint</a>
        </div>
        </div>
        </div>
        <div class="col-md-4">
         ...
         <a href="<?php echo e(route('library')); ?>" class="btn btn-primary">Make Complaint</a>
        </div>
        </div>
        </div>
        <div class="col-md-4">
         ...
         <a href="<?php echo e(route('transport')); ?>" class="btn btn-primary">Make Complaint</a>
        </div>
        </div>
        </div>
        <div class="col-md-4">
         ...
         <a href="<?php echo e(route('canteen')); ?>" class="btn btn-primary">Make Complaint</a>
        </div>
        </div>
        </div>
        <div class="col-md-4">
         ...
         <a href="<?php echo e(route('account')); ?>" class="btn btn-primary">Make Complaint</a>
        </div>
        </div>
        </div>
        <div class="col-md-4">
         ...
         <a href="<?php echo e(route('hostel')); ?>" class="btn btn-primary">Make Complaint</a>
        </div>
        </div>
        </div>
...
<?php /**PATH E:\xampp\htdocs\DIU_CMS\resources\views/home.blade.php ENDPATH**/ ?>