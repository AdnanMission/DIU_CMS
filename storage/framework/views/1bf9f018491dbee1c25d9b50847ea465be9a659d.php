...
<div class="container">
	<table  cellspacing="0" cellpadding="0" class="table table-responsive table-hover" style="max-width:1400px; max-height: 450px; font-size:14px; ">
		...
		<?php $i++ ?>
		<tr>
			<?php if($complaint_tbl->action == "Closed"): ?>
			<td><?php echo e($i); ?></td>
            ...
            <td><?php echo e($complaint_tbl->action); ?></td>
				...
				<!-- <td><a href="<?php echo e(route('edit1',$complaint_tbl->id)); ?>" class="btn btn-success">Action</a>
				<a href="<?php echo e(route('delete',$complaint_tbl->id)); ?>" class="btn btn-danger">Delete</a></td>-->
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DIU_CMS\resources\views/cnewcomplaint.blade.php ENDPATH**/ ?>