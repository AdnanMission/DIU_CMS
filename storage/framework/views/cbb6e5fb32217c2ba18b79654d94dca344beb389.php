...
<div class="container-fluid bg-primary text-black  py-4 " style="margin: 0 auto" >
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="types" value="<?php echo e(old('types')); ?>" required autocomplete="types" autofocus>
                                	<option>-----Types----</option>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="complaint_date" value="<?php echo e(old('complaint_date')); ?>" required autocomplete="complaint_date" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="description_of_complaint" required autocomplete="description_of_complaint" rows="5">
                               </textarea> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DIU_CMS\resources\views/complaint.blade.php ENDPATH**/ ?>