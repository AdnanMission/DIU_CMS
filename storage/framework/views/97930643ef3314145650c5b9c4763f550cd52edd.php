...
<div class="container">
<table  cellspacing="0" cellpadding="0" class="table table-responsive table-hover" style="max-width:1400px; max-height: 450px; font-size:12px; ">
		<tr>
			<th>Complaint_no</th>
			<th>Name</th>
			<th>Student_id</th>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DIU_CMS\resources\views/dnewcomplaint.blade.php ENDPATH**/ ?>